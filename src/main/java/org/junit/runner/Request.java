...
public abstract class Request {
    ...
    public static Request method(Class<?> clazz, String methodName) {
        @NotNull Description method = Description.createTestDescription(clazz, methodName);
    ...
    public static Request classes(Computer computer, Class<?>... classes) {
        try {
            @NotNull AllDefaultPossibilitiesBuilder builder = new AllDefaultPossibilitiesBuilder();

...
public class MaxHistory implements Serializable {
    ...
    private static MaxHistory readHistory(@NotNull File storedResults)
        ...
        try {
            @NotNull FileInputStream file = new FileInputStream(storedResults);
            try {
                @NotNull ObjectInputStream stream = new ObjectInputStream(file);
                try {
    ...
    private void save() throws IOException {
        @NotNull ObjectOutputStream stream = new ObjectOutputStream(new FileOutputStream(
                fHistoryStore));
